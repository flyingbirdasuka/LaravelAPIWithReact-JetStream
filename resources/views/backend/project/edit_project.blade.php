                        ...
                        <div class="basic-form">
                            <form method="post" action="{{route('project.update', $project->id)}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="project_name" id="service_name" type="text" value="{{$project->project_name}}">
                                    @error('project_name')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="project_features" rows="4" id="comment">{{$project->project_features}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label class="info-title">Live Preview</label>
                                    <input class="form-control" name="live_preview" id="live_preview" type="text" value="{{$project->live_preview}}">
                                </div>
                                <div class="input-group mb-3">
                                    ...
                                    <div class="form-group">
                                    <img id="showImageOne" src="{{ asset($project->img_one)}}" style="width:100px; height:100px;">
                                    </div>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <div class="form-group">
                                    <img id="showImageTwo" src="{{asset($project->img_two)}}" style="width:100px; height:100px;">
                                    </div>
                                </div>
