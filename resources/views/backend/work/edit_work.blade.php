                        ...
                        <div class="basic-form">
                            <form method="post" action="{{route('work.update',$work->id)}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="title" id="title" type="text" value="{{$work->title}}">
                                </div>
                                <div class="form-group">
                                    <label class="info-title">Year</label>
                                    <input class="form-control" name="year" id="year" type="text"value="{{$work->year}}" >
                                </div>
                                <div class="form-group">
                                    <label class="info-title">Description</label>
                                    <textarea class="form-control" name="description" rows="4" id="summernote">{{$work->description}}</textarea>
                                </div>
                                
                                <input type="submit" class="btn btn-success" value="Update Work">
                            </form>
                        </div>
                    </div>
                </div>
